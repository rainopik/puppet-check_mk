...
Tested on Redhat-like systems and Debian Wheezy.
...
```puppet
    ...
    class { 'check_mk':
      package           => 'omd-1.20',
      omd_service_name  => 'omd-1.20',
      require           => Apt::Source['consol-de-wheezy'],
    }
```

Installs on Debian Wheezy from consol.de repositories.
